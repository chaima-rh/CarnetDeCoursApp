...
<body>
    ...
    <div class="container mt-4">
        ...
        <div class="welcome-section">
            <h2><i class="fas fa-edit me-2"></i>Modifier les informations de l'étudiant</h2>
            <p class="mb-0">Modifiez les détails de l'étudiant dans le formulaire ci-dessous</p>
        </div>

      
        <div class="content-card">
            <?php foreach($u as $s){?>
            <form action="etudiant_update.php" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="id" value="<?= $s['id_etudiant'] ?>" />
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" value='<?= $s['num_etudiant'] ?>' name="num" required />
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" value='<?= $s['nom'] ?>' name="nom" required />
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-between mt-5">
                    <a href="etudiant_display.php" class="btn btn-secondary">
